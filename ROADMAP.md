...
| **Статус** | В работе. На 2026-04-12 зафиксирован foundation slice: broker-контракт с consumer groups, versioned plugin registry, воспроизводимый load scenario для broker foundation и web control plane для конфигурации broker/module/plugin/scope без backend-зависимости в dev-режиме. |
