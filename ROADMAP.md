...
| **Статус** | В работе. На 2026-04-11: каноническая матрица `v1.*` и правила обратной совместимости вынесены в отдельный артефакт `EVENT_MATRIX.md`; следующий шаг — усилить критические пути тестами и закрыть gated AI integration. |
