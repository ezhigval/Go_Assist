...
| **Статус** | В работе. На 2026-04-12 зафиксирован foundation slice: broker-контракт с consumer groups, versioned plugin registry с security-guardrails (relative entry, permission allowlist, runtime/protocol checks), воспроизводимый load scenario для broker foundation и web control plane с минимальным UX contract для конфигурации broker/module/plugin/scope без backend-зависимости в dev-режиме. |
