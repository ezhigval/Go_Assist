...
| **Статус** | В работе. На 2026-04-11 закрыты runtime-level scope isolation, observability и scope-aware read-path для `event_journal`; полноценный DB-enforced RLS / session-level scope storage остаётся следующим шагом. |
