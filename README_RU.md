...
|----------|-------------|------|
| **Architecture** | System design and data flow | [Architecture_RU.md](./Architecture_RU.md) |
| **Concepts** | Core concepts and terminology | [Concepts_RU.md](./Concepts_RU.md) |
| **Modules** | Module development guide | [Modules_RU.md](./Modules_RU.md) |
| **AI Layer** | AI behavior and integration | [AI_RU.md](./AI_RU.md) |
